...
xml.feed "xmlns" => "http://www.w3.org/2005/Atom" do
  ...
  xml.id   'http://2013.eurucamp.org/'
  xml.link href: 'http://2013.eurucamp.org/'
  xml.link href: 'http://2013.eurucamp.org/feed.xml', rel: 'self'
  ...
  blog.published_articles[0..5].each do |article|
    xml.entry do
      full_url = "http://2013.eurucamp.org" + article.url_without_extension
